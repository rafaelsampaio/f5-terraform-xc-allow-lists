...
output "all_ranges" {
  ...
  value = distinct(concat(local.container_registries, local.dns_zone_transfer_with_mask, local.dnslb_health_check_with_mask, local.global_log_receivers, local.range_ipv4_tcp, local.range_ipv4_udp))
}
